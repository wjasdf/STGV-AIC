function [y_est,blocks] = CBM3D1(z, sigma_psd, profile, colorspace,blocksmatch,blocks)
...
% There have been changes, and it can return the index of similar blocks
...
% Call BM3D
if(blocksmatch)
    [y_est,blocks] = BM3D(z, psd, profile, blocksmatch);
else
    y_est= BM3D(z, psd, profile, blocks);
end
